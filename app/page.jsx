...
export default function Home() {
  return (
    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 ng bg-background">
  ...
  <div className="container mx-auto px-4 md:px-6">
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col items-center justify-center space-y-2">
        ...
        <p className="text-muted-foreground">Career Tools</p>
      </div>
      <div className="flex flex-col items-center justify-center space-y-2">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 ng bg-background">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {howItWorks.map((Item,index)=>{
         ...
         <section className="w-full py-12 md:py-24 lg:py-32 ng bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <h2 className="text-3xl font-bold mb-4">
            ...
            <p className="text-muted-foreground">
              Common questions about our AI-powered career tools
            </p>
          </div>
